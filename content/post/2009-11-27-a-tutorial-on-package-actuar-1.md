...
<p align="left">
  ![image004](https://cos.name/wp-content/uploads/2009/11/image004-500x205.jpg)
</p>
...
&gt; plot(Fnt)</pre>
  ...
  <p>
    ![image008](https://cos.name/wp-content/uploads/2009/11/image008-150x150.jpg)
  </p>
...
&gt; plot(lev2,type='o',pch=19)</pre>
  ...
  <p>
    ![image018](https://cos.name/wp-content/uploads/2009/11/image018-499x276.jpg)
  </p>
...
&gt; curve(theta*exp(1)^(-theta*x),from=0,to=4000,add=T,col='red')</pre>
  ...
  <p>
    ![image052](https://cos.name/wp-content/uploads/2009/11/image052-500x292.jpg)
  </p>
