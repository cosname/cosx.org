...
<pre>![808D.tmp](https://cos.name/wp-content/uploads/2016/05/808D.tmp_.png)                    图1中国民用汽车保有量与年增长率时间序列图</pre>
...
<pre>![C27E.tmp](https://cos.name/wp-content/uploads/2016/05/C27E.tmp_.png)                       图 2 2004-2013 年中国汽车销量（万辆）</pre>

<pre>![3520.tmp](https://cos.name/wp-content/uploads/2016/05/3520.tmp_.png)                       图 3 全球高端汽车销售排名（千辆）</pre>

<pre>![8305.tmp](https://cos.name/wp-content/uploads/2016/05/8305.tmp_.jpg)               图 4 2007-2016 年中国奥迪、宝马、奔驰汽车销量（万辆）</pre>
...
<pre>![C63E.tmp](https://cos.name/wp-content/uploads/2016/05/C63E.tmp_.jpg)                         图 5 百度搜索“奥迪A6”结果</pre>
...
<pre>![4A6D.tmp](https://cos.name/wp-content/uploads/2016/05/4A6D.tmp_.png)</pre>

<pre>![91DA.tmp](https://cos.name/wp-content/uploads/2016/05/91DA.tmp_.png)</pre>
...
<pre>![BBE8.tmp](https://cos.name/wp-content/uploads/2016/05/BBE8.tmp_.png)                     图 6 高端属性的三个维度：生活、事业、学业</pre>
...
<pre>![D553.tmp](https://cos.name/wp-content/uploads/2016/05/D553.tmp_.png)                                图 7 高端属性（生活）</pre>
...
<pre>![C687.tmp](https://cos.name/wp-content/uploads/2016/05/C687.tmp_.png)                              图 8 高端属性（学业）</pre>
...
<pre>![CD7D.tmp](https://cos.name/wp-content/uploads/2016/05/CD7D.tmp_.png)                               图 9 高端属性（事业）</pre>
...
<pre>![9486.tmp](https://cos.name/wp-content/uploads/2016/05/9486.tmp_.png)                            图 10 高端车搜索量统计</pre>

<pre>![414A.tmp](https://cos.name/wp-content/uploads/2016/05/414A.tmp_.png)                              图 11 汽车媒体点击量统计</pre>
...
<pre>![A4FE.tmp](https://cos.name/wp-content/uploads/2016/05/A4FE.tmp_.png)                    图 12 用户搜索高端车品牌转移概率矩阵</pre>
...
<pre>![A435.tmp](https://cos.name/wp-content/uploads/2016/05/A435.tmp_.png)                         图 13 高端车品牌层次聚类分析结果</pre>
...
<pre>![7BA.tmp](https://cos.name/wp-content/uploads/2016/05/7BA.tmp_.png)                             图 14 搜索品牌数</pre>
...
<pre>![51E8.tmp](https://cos.name/wp-content/uploads/2016/05/51E8.tmp_.png)                        图 15 log(1+x)变换后搜索时间间隔</pre>
...
<pre>![8E0F.tmp](https://cos.name/wp-content/uploads/2016/05/8E0F.tmp_.png)                           图 16 同一品牌连续搜索数</pre>
...
<pre>![A78A.tmp](https://cos.name/wp-content/uploads/2016/05/A78A.tmp_.png)                                    图 17 搜索词长度</pre>
...
<pre>![B9C4.tmp](https://cos.name/wp-content/uploads/2016/05/B9C4.tmp_.png)                              图 18 是否搜索配置信息</pre>

###### ****（6）****点击数

点击数，是指用户上一步搜索后产生的点击次数。从描述性分析（图 19）可以看出，忠诚用户搜索后产生的平均点击高于“叛变”用户。点击越多说明用户在一次搜索之后了解信息的意愿更强，也是深度用户的侧面反映。

<pre>![A463.tmp](https://cos.name/wp-content/uploads/2016/05/A463.tmp_.png)                                图 19 搜索后点击数</pre>
...
<pre>![5961.tmp](https://cos.name/wp-content/uploads/2016/05/5961.tmp_.png)                       图 20 搜索后是否点击问答百科类网站</pre>
...
<pre>![C38A.tmp](https://cos.name/wp-content/uploads/2016/05/C38A.tmp_.png)</pre>

同时，我们得到了控制自变量后的品牌忠诚度系数的估计结果，系数估计值如图 21中柱状图所示。可以看到，在控制自变量之后，忠诚度最高的三个品牌分别为，奥迪、奔驰和林肯，宝马位居第四。

<pre>![39F3.tmp](https://cos.name/wp-content/uploads/2016/05/39F3.tmp_.png)                           图 21 忠诚度系数估计值</pre>
...
<pre>![FBAE.tmp](https://cos.name/wp-content/uploads/2016/05/FBAE.tmp_.png)                        图 22 忠诚模型成本收益曲线</pre>
