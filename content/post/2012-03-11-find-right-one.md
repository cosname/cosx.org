...
[<img class="alignleft  wp-image-4911" src="http://cos.name/wp-content/uploads/2012/03/BFGF-300x281.png" alt="" width="240" height="225" srcset="http://cos.name/wp-content/uploads/2012/03/BFGF-300x281.png 300w, http://cos.name/wp-content/uploads/2012/03/BFGF-319x300.png 319w, http://cos.name/wp-content/uploads/2012/03/BFGF.png 342w" sizes="(max-width: 240px) 100vw, 240px" />](http://cos.name/wp-content/uploads/2012/03/BFGF.png)谈到相亲就不得不提到著名的麦穗问题。说有一天，苏格拉底带领几个弟子来到一块成熟的麦地边。他对弟子们说：“你们去麦地里摘一个最大的麦穗，但要求只能摘一次，只许进不许退，我在麦地的尽头等你们。”可以看得出，相亲这种活动就有点类似于摘麦穗，在等待和决断之间达成平衡是解决问题的重点。
...
<a href="http://cos.name/2012/03/find-right-one/result01/" rel="attachment wp-att-4898"><img class="size-full wp-image-4898" src="http://cos.name/wp-content/uploads/2012/03/result01.jpeg" alt="" width="600" height="400" srcset="http://cos.name/wp-content/uploads/2012/03/result01.jpeg 600w, http://cos.name/wp-content/uploads/2012/03/result01-300x200.jpg 300w, http://cos.name/wp-content/uploads/2012/03/result01-500x333.jpg 500w, http://cos.name/wp-content/uploads/2012/03/result01-450x300.jpg 450w" sizes="(max-width: 600px) 100vw, 600px" /></a><figcaption class="wp-caption-text">横轴表示了不同的划分参数n，纵轴表示给定n条件下，能得到最优值的频数</figcaption></figure> 
...
<a href="http://cos.name/2012/03/find-right-one/result02/" rel="attachment wp-att-4899"><img class="size-full wp-image-4899" src="http://cos.name/wp-content/uploads/2012/03/result02.jpeg" alt="" width="600" height="400" srcset="http://cos.name/wp-content/uploads/2012/03/result02.jpeg 600w, http://cos.name/wp-content/uploads/2012/03/result02-300x200.jpg 300w, http://cos.name/wp-content/uploads/2012/03/result02-500x333.jpg 500w, http://cos.name/wp-content/uploads/2012/03/result02-450x300.jpg 450w" sizes="(max-width: 600px) 100vw, 600px" /></a><figcaption class="wp-caption-text">横轴为不同的划分参数n，纵轴表示10000次模拟的期望值</figcaption></figure> 
...
<a href="http://cos.name/2012/03/find-right-one/result03/" rel="attachment wp-att-4900"><img class="size-full wp-image-4900" src="http://cos.name/wp-content/uploads/2012/03/result03.jpeg" alt="" width="600" height="400" srcset="http://cos.name/wp-content/uploads/2012/03/result03.jpeg 600w, http://cos.name/wp-content/uploads/2012/03/result03-300x200.jpg 300w, http://cos.name/wp-content/uploads/2012/03/result03-500x333.jpg 500w, http://cos.name/wp-content/uploads/2012/03/result03-450x300.jpg 450w" sizes="(max-width: 600px) 100vw, 600px" /></a><figcaption class="wp-caption-text">进行对象选取的一万次模拟，每次模拟返回选取对象所需要的尝试次数，0表示未能得到任何对象，1表示在观察七个对象后，只需要一次尝试就得到较优的对象。</figcaption></figure> 
