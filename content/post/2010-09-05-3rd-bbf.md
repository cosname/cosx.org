...
description: "9月4号下午，周六，去北大医学部参加了北京数据管理与生物统计论坛（Beijing Biometrics Forum， BBF）的第三次聚会，这次活动由 SAS China 和北京大学临床研究所赞助。这里写些会议见闻和一些零散的感想，不算是会议的正式“[纪要]北京SAS技术社区的氛围、工作市场情况以及一些相关技术评论等等。"
