...
![第二届中国R语言会议北京会场合影](https://uploads.cosx.org/wp-content/uploads/2009/12/2nd-R-Conf-BJ.jpg "第二届中国R语言会议北京会场合影")
<p style="text-align: center;">第二届中国R语言会议北京会场合影</p>

![第二届中国R语言会议上海会场演讲者和工作人员合影](https://uploads.cosx.org/wp-content/uploads/2009/12/2nd-R-Conf-SH.jpg "第二届中国R语言会议上海会场演讲者和工作人员合影")
...
![useR eveRywheRe](https://uploads.cosx.org/wp-content/uploads/2009/12/useR-eveRywheRe.png "useR eveRywheRe")
...
本次会议要特别感谢各位演讲者的大力支持，他们为演讲报告付出了大量的精力和时间，有的不远千里奔赴两地进行演讲，有的则是通宵达旦修改讲稿。在总共为期四天的会议时间中，共举行了正式演讲34场，其中北京会场19场，上海会场15场。以下演讲资料都遵守[CC协议](http://creativecommons.org/licenses/by/3.0/deed.zh)，其中部分遵守[CC2.5协议](http://creativecommons.org/licenses/by-nc-sa/2.5/cn/)：

北京会场：

  * 陈堰平：[会议开幕及R语言基础](https://uploads.cosx.org/wp-content/uploads/2009/12/R-introduction.pdf)
  * 高涛、李程：[统计图形概览与其在R下的实现](https://uploads.cosx.org/wp-content/uploads/2009/12/Statistical-graphics.pdf)
  * 关菁菁：[RExcel应用  数据挖掘方法现代发展趋势](https://uploads.cosx.org/wp-content/uploads/2009/12/RExcel-and-data-mining.pdf)
  * 钟其顶：[R在食品标准研制中的应用与展望](https://uploads.cosx.org/wp-content/uploads/2009/12/R-application-in-food-industry.pdf)
  * 肖楠：[R环境安全特性初探与前瞻](https://uploads.cosx.org/wp-content/uploads/2009/12/Security-in-R-environment.pdf)
  * 宫雨：[Integrate R into Your C/C++ Application using Visual C++ 2008](https://uploads.cosx.org/wp-content/uploads/2009/12/Integrate-R-into-C.pdf)（CC2.5）
  * 刘永生：[地质环境调查监测研究中的R应用](https://uploads.cosx.org/wp-content/uploads/2009/12/R-in-geological-research.pdf)
  * 奚潭：[R在灰色系统理论方面的应用](https://uploads.cosx.org/wp-content/uploads/2009/12/An-IntRoduction-to-gRey-methods-using-R.pdf)
  * 刘思喆：[R在大规模数据整理及自动化报告方面的应用](https://uploads.cosx.org/wp-content/uploads/2009/12/R-in-large-dataset-and-Sweave.pdf)
  * 祝迎春：[R在市场研究中的应用](https://uploads.cosx.org/wp-content/uploads/2009/12/R-in-marketing-research.pdf)
  * 孙晓燕、王婷：[R心理学笔记](https://uploads.cosx.org/wp-content/uploads/2009/12/Notes-on-psychology-with-R.pdf)
  * 左辰：[非参数方法与稳健性估计初探](https://uploads.cosx.org/wp-content/uploads/2009/12/Nonparametric-methods-and-robust-estimation.pdf)（CC2.5）
  * 魏太云：[矩阵可视化及corrplot包的介绍](https://uploads.cosx.org/wp-content/uploads/2009/12/An-Introduction-to-Matrix-Visualization-and-corrplot-Package.pdf)
  * 陈丽云：[从经济学到R语言：在经济和计量中使用R](https://uploads.cosx.org/wp-content/uploads/2009/12/From-Economics-to-R.pdf)（CC2.5）
  * 孙蝶：[R在近红外光谱分析中的应用](https://uploads.cosx.org/wp-content/uploads/2009/12/R-application-in-agriculture.pdf)
  * 王化儒：[R在空间分析中的应用初探](https://uploads.cosx.org/wp-content/uploads/2009/12/R-and-Spatial-Analysis.pdf)
  * 丁鹏：[R and WinBugs](https://uploads.cosx.org/wp-content/uploads/2009/12/R-and-WinBUGS-by-Ding-Peng.pdf)
  * 马斌：[应用omd包对QSAR分析中分子结构参数矩阵的优化](https://uploads.cosx.org/wp-content/uploads/2009/12/omd-and-QSAR.pdf)
  * 黄志一：[WebR–R在线分析及在大气数据分析中的应用](https://uploads.cosx.org/wp-content/uploads/2009/12/Web-R.pdf)

上海会场：

  * 汤银才老师：[R与WinBUGS](https://uploads.cosx.org/wp-content/uploads/2009/12/R-and-WinBUGS.pdf)
  * 林光启：[R和统计在半导体界的应用](https://uploads.cosx.org/wp-content/uploads/2009/12/R-application-in-semiconductor-manufacturing.pdf)
  * 魏太云：矩阵可视化及corrplot包的介绍（见北京会场）
  * 高涛、李程：统计图形概览与其在R下的实现（见北京会场）
  * 王卫杰：[基于rpart包的决策树应用](https://uploads.cosx.org/wp-content/uploads/2009/12/Decision-tree.pdf)
  * 于怡：[Survival Analysis in R](https://uploads.cosx.org/wp-content/uploads/2009/12/Survival-Analysis-in-R.pdf)
  * 马斌：应用omd包对QSAR分析中分子结构参数矩阵的优化（见北京会场）
  * 奚潭：R在灰色系统理论方面的应用（见北京会场）
  * 陈丽云：从经济学到R语言：在经济和计量中使用R（见北京会场）
  * 肖楠：R环境安全特性初探与前瞻（见北京会场）
  * 刘思喆：[153分钟学会R](https://uploads.cosx.org/wp-content/uploads/2009/12/Learning-R-in-153-minutes.pdf)
  * 刘思喆：R在大规模数据整理及自动化报告方面的应用（见北京会场）
  * 李舰：[R在应用领域的扩展——JAVA开发和最优化](https://uploads.cosx.org/wp-content/uploads/2009/12/JAVA-and-optimization.pdf)
  * 谢益辉（刘思喆代讲）：[怎么写R包](https://uploads.cosx.org/wp-content/uploads/2009/12/Writing-R-PKG.pdf)
  * 林帧舜：[Marketing Analytical Framework](https://uploads.cosx.org/wp-content/uploads/2009/12/Marketing-Analytical-Framework.pdf)
...
本次会议所用的胸牌完全是用R代码生成的，其中用到了rimage这个包（现在CRAN上不再提供rimage包的Windows版本，如果想要测试代码的话可以到[这里](https://uploads.cosx.org/wp-content/uploads/2009/12/rimage.zip)下载一个较早版本的rimage包）：
