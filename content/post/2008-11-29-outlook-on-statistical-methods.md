...
[<img class="size-full wp-image-142" src="http://cos.name/wp-content/uploads/2008/11/obj-function-for-qr.png" alt="分位回归目标函数示意图" width="317" height="273" srcset="http://cos.name/wp-content/uploads/2008/11/obj-function-for-qr.png 317w, http://cos.name/wp-content/uploads/2008/11/obj-function-for-qr-300x258.png 300w" sizes="(max-width: 317px) 100vw, 317px" />](http://cos.name/wp-content/uploads/2008/11/obj-function-for-qr.png)<figcaption class="wp-caption-text">图1 分位回归目标函数示意图</figcaption></figure> 
...
[<img class="size-full wp-image-143" src="http://cos.name/wp-content/uploads/2008/11/quantile-regression-income-expenditure.png" alt="图2 收入与支出的分位回归" width="478" height="474" srcset="http://cos.name/wp-content/uploads/2008/11/quantile-regression-income-expenditure.png 478w, http://cos.name/wp-content/uploads/2008/11/quantile-regression-income-expenditure-150x150.png 150w, http://cos.name/wp-content/uploads/2008/11/quantile-regression-income-expenditure-300x297.png 300w" sizes="(max-width: 478px) 100vw, 478px" />](http://cos.name/wp-content/uploads/2008/11/quantile-regression-income-expenditure.png)<figcaption class="wp-caption-text">图2 家庭收入与食品支出：一个分位数回归的例子</figcaption></figure> 
