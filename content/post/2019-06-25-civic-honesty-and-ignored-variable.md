...
4. 对上面这点我表示怀疑，并且用**作者提供的数据**给出了不一样的结果。
...
实验设计者虽然精心控制了很多因素的影响，但这毕竟是跨越四十个国家的社会实验，很难保证没有瑕疵。实验设计中没有尽力控制的因素，如果对归还率有潜在的影响，那么就会影响到最终对于“诚信度”的判断。在各国网友的[热切反馈](https://marginalrevolution.com/marginalrevolution/2019/06/civic-honesty-around-the-globe.html)中，以下列举了实验中没有控制的因素：
