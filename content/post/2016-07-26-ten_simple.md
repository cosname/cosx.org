...
这就是为何与统计学家合作会对研究非常有帮助，以及越早合作，效果就越好的原因 。详情请参考原则 **2**。<!--more-->
...
常见的统计模型都会用到线性关系的假设。例如普通相关系数，又叫 Pearson 相关系数，是线性关联的测量。
...
研究者所面临的一个核心且常见的课题就是揭示数据所能告诉我们关于要研究的科学问题的信息。
