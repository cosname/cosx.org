...
> 本文是R中mcmc包的一篇<a href="http://www.stat.umn.edu/geyer/mcmc/library/mcmc/doc/demo.pdf" target="_blank">帮助文档</a>，作者为Charles J.Geyer。经过<a href="/2012/06/reproducible-research-with-knitr/" target="_blank">knitr</a>编译后的pdf文档<a href='http://cloud.github.com/downloads/cosname/editor/mcmc.pdf' target="_blank">可见此处</a>，提供中文译稿的作者：
