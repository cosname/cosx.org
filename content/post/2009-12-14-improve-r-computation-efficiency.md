...
前两天COS论坛上有个帖子提到“<a title="http://cos.name/bbs/read.php?tid=17601" href="http://cos.name/bbs/read.php?tid=17601" target="_blank">R语言的执行效率问题</a>”，大意如下：
...
[<img class="size-full wp-image-1802" title="P值的差异" src="http://cos.name/wp-content/uploads/2009/12/p-values-error.png" alt="P值的差异" width="480" height="480" srcset="http://cos.name/wp-content/uploads/2009/12/p-values-error.png 480w, http://cos.name/wp-content/uploads/2009/12/p-values-error-150x150.png 150w, http://cos.name/wp-content/uploads/2009/12/p-values-error-300x300.png 300w" sizes="(max-width: 480px) 100vw, 480px" />](http://cos.name/wp-content/uploads/2009/12/p-values-error.png)<figcaption class="wp-caption-text">P值的差异</figcaption></figure> 
