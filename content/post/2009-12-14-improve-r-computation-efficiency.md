...
[![P值的差异](https://cos.name/wp-content/uploads/2009/12/p-values-error.png "P值的差异")](https://cos.name/wp-content/uploads/2009/12/p-values-error.png)<figcaption class="wp-caption-text">P值的差异</figcaption></figure> 
