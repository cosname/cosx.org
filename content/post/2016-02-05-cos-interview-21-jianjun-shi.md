...
![jianjun](https://cos.name/wp-content/uploads/2016/02/jianjun.png)
...
> **“如果说应用是一个点，统计是一个点，那么两点中间就是我们**<strong>工业工程**<strong>中的应用统计。IE要搞系统，要解决这个接口。从实际应用出发，建立新的统计方法从而解决这个问题。如果理论功底足够好，还要能够研究这个新的统计方法的各类性质，为统计领域也作出贡献。”**
> － IE视角下的应用统计学研究
>
> **“IE必须了解工程背景，社会背景。”**
> － IE研究工作的独特性
