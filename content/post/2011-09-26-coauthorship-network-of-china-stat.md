...
此拙作成文于几个月之前，与逸波兄的大作《<a href="https://cos.name/2011/04/exploring-renren-social-network/" target="_blank">社会网络分析：探索人人网好友推荐系统</a>》属同期同类之作。由于当时担心会引起是非或争议，所以犹豫再三而没有发布。现在想来，我们还是应该开放一点、宽容一点，所以请大家不妨以“纯洁”的眼光看待这里研究的关系网络，并望各路高人：口中留情，手下留轻。 🙂<!--more-->
...
[![Hosted by imgur.com](http://i.imgur.com/mtWdVqG.png)](http://imgur.com/mtWdVqG)
...
[![Hosted by imgur.com](http://i.imgur.com/JAHHoVb.png)](http://imgur.com/JAHHoVb)

经过拼音排序后没有去重的作者列表（一共6568位，以前20位为例）：

[![Hosted by imgur.com](http://i.imgur.com/rNxhNTJ.png)](http://imgur.com/rNxhNTJ)

不同作者发表论文的频次表（一共4293位不同的作者，以后50位为例）：

[![Hosted by imgur.com](http://i.imgur.com/HWwCiOV.png)](http://imgur.com/HWwCiOV)
...
[![Hosted by imgur.com](http://i.imgur.com/RKpO0Da.png)](http://imgur.com/RKpO0Da)

由表5可以看出，平均每位作者发表1～2篇论文，极个别人发表了33篇论文。而从图1中我们可以发现，在核心期刊发表1～3篇文章的人占了绝大多数，能发5篇以上的人就非常少了。

[![Hosted by imgur.com](http://i.imgur.com/Hr4X6s7.png)](http://imgur.com/Hr4X6s7)

由表5和图2可以看出，一个人发文章或者两到三个人合写文章的情况比较常见，一篇文章的作者数超过4人的情况极少。值的注意的是，有一篇文章的作者数达到了18人，通过查找原始数据，发现它是一篇国际统计论坛的综述，其作者是该论坛主办单位的许多老师。

[![Hosted by imgur.com](http://i.imgur.com/fAirxpC.png)](http://imgur.com/fAirxpC)

我们还能从表5和图3中发现，平均每位作者大约有1～2位合著者，“单干”的情况也较常见，为数不多的人会有10个以上的合著者。

[![Hosted by imgur.com](http://i.imgur.com/g7BGgSw.png)](http://imgur.com/g7BGgSw)
...
[![Hosted by imgur.com](http://i.imgur.com/Pi1e2zh.png)](http://imgur.com/Pi1e2zh)
...
[![Hosted by imgur.com](http://i.imgur.com/la7fTCC.png)](http://imgur.com/la7fTCC)
...
[![Hosted by imgur.com](http://i.imgur.com/gjmgXCy.png)](http://imgur.com/gjmgXCy)

我们的合著关系网中，顶点强度最大值是20，最小值是0，平均数是1.2，中位数是1。顶点的强度排名前10的作者如下表所示：

[![Hosted by imgur.com](http://i.imgur.com/emTvDtp.png)](http://imgur.com/emTvDtp)

**顶点的中间性**是经过该顶点的最短路径的条数（给定顶点对之间若有多条最短路径，则不重复计算）。顶点的中间性反映了顶点起“桥梁”作用的大小。不过我们现在将最短路径替换为加权最短路径。顶点的中间性排名前10的作者如下表所示：

[![Hosted by imgur.com](http://i.imgur.com/WG8skx5.png)](http://imgur.com/WG8skx5)

**顶点的接近性**是某顶点到所有其他顶点的平均最短路径长度的倒数：

[![Hosted by imgur.com](http://i.imgur.com/gMt5Xz4.png)](http://imgur.com/gMt5Xz4)
...
[![Hosted by imgur.com](http://i.imgur.com/ovJsSlo.png)](http://imgur.com/ovJsSlo)
...
[![Hosted by imgur.com](http://i.imgur.com/vwGo8SI.png)](http://imgur.com/vwGo8SI)
...
[![Hosted by imgur.com](http://i.imgur.com/kjAxC4F.png)](http://imgur.com/kjAxC4F)
...
[![Hosted by imgur.com](http://i.imgur.com/rluLie4.png)](http://imgur.com/rluLie4)
...
[![Hosted by imgur.com](http://i.imgur.com/IoA76MU.png)](http://imgur.com/IoA76MU)
  
[![Hosted by imgur.com](http://i.imgur.com/sd2gJZ5.png)](http://imgur.com/sd2gJZ5)
  
[![Hosted by imgur.com](http://i.imgur.com/dkz3ee0.png)](http://imgur.com/dkz3ee0)
  
[![Hosted by imgur.com](http://i.imgur.com/qRNuJSG.png)](http://imgur.com/qRNuJSG)
  
[![Hosted by imgur.com](http://i.imgur.com/xUsXWRf.png)](http://imgur.com/xUsXWRf)

为了更直观地了解这24个社群，我们将383位作者构成的网络进行可视化展示，如图8所示。图中一共有24种渐变的颜色，每种颜色代表一个合著社群，圆圈的大小与顶点的强度正相关，线条的粗细与边的权重正相关。

[![Hosted by imgur.com](http://i.imgur.com/HHHS5jN.jpg)](http://imgur.com/HHHS5jN)
...
[![Hosted by imgur.com](http://i.imgur.com/u2NANwJ.jpg)](http://imgur.com/u2NANwJ)图9   CMN算法社群挖掘效果可视化
