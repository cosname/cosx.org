...
![“正常的”QQ图（来自R语言qqnorm(rnorm(30)))](https://uploads.cosx.org/wp-content/uploads/2011/07/normal-qq-plot.png)
...
![真实的正态分布QQ图（图中直线为y = x）](https://uploads.cosx.org/wp-content/uploads/2011/07/true-qq-norm.gif)
