...
![本文框架](https://uploads.cosx.org/2021/03/image-20211116131444590.png)
...
![创建新的项目](https://uploads.cosx.org/2021/03/image-20210719154631549.png)
...
![新建界面时的设置](https://uploads.cosx.org/2021/03/image-20210719145109508.png)

新建后界面如下，右下角给出了整个项目的文件。其中，圈起来的最为关键，稍后详细介绍。先编译这个初始 `blogdown`。

![初始 blogdown](https://uploads.cosx.org/2021/03/image-20210719145533256.png)

选择 `Tool - addins`（Windows 更方便找到）然后选择以下按钮。

![addins 插件](https://uploads.cosx.org/2021/03/image-20210719144620808.png)
...
![`config.yaml` 文件](https://uploads.cosx.org/2021/03/image-20210719160220457.png)

主要修改内容：`title`（第 4 行），`subtitle`（第 84 行）。保存该文件，右下角即可快速得到以下界面：

![本地网站](https://uploads.cosx.org/2021/03/image-20210719160440312.png)

如果想修改头像，可以在该 `yaml` 文件的第 34 行找到代码 `avatar: /images/me/avatar.jpeg`。此时从桌面打开该文件夹，更换该 JPEG 文件即可，例如：

![修改头像](https://uploads.cosx.org/2021/03/image-20210719160756100.png)
...
![修改后的 blog](https://uploads.cosx.org/2021/03/image-20210719161006304.png)
...
-   GitHub 桌面版本操作
    ...
    ![](https://uploads.cosx.org/2021/03/image-20210719150226752.png)

    之后如果出现以下界面，点击蓝色字

    ![](https://uploads.cosx.org/2021/03/image-20210719150332449.png)

    跳转到以下界面，设置线上 GitHub 对应仓库的相关信息。

    ![](https://uploads.cosx.org/2021/03/image-20210719150402141.png)

    之后将创建好的仓库 publish 上去。`Keep this code private` 勾不勾都可以，勾选后仓库只能自己查看，不勾选取就将其变成公开的仓库。

    ![](https://uploads.cosx.org/2021/03/image-20210719152432162.png)

-   查看是否上传

    检查 GitHub 是否有这个仓库，如下：

    ![](https://uploads.cosx.org/2021/03/image-20210719152558356.png)
...
![](https://uploads.cosx.org/2021/03/image-20210719150812523.png)

点击  `New site from Git`，跟着步骤往下做。点击左下角的 Github，选择刚才创建的仓库（`zss`）。

![](https://uploads.cosx.org/2021/03/image-20210719150849453.png)

根据以下界面进行部署网站。

![](https://uploads.cosx.org/2021/03/image-20210719151017788.png)

等待部署，得到以下界面。注意，读者可以通过 `Site settings` 修改自己的网站名。你可以到 Porkbun 或 Namecheap 等网站购买专属域名。

![](https://uploads.cosx.org/2021/03/image-20210719151045133.png)

点击网站链接，即可得到私人网站啦！

![](https://uploads.cosx.org/2021/03/image-20210719151437396.png)

> 恭喜你，你已经会简单创建自己的网站啦！

![](https://uploads.cosx.org/2021/03/image-20210719153023496.png)

![白色版本](https://uploads.cosx.org/2021/03/image-20210719153323458.png)

![黑色版本](https://uploads.cosx.org/2021/03/image-20210719153341901.png)
...
![GitHub 桌面版本界面](https://uploads.cosx.org/2021/03/image-20210725171639643.png)
...
![选中红色框，执行](https://uploads.cosx.org/2021/03/image-20210725171808872.png)
...
![New Post 示例](https://uploads.cosx.org/2021/03/image-20210725172050133.png)

### 2.2 填写内容

如果提前已经渲染了博客，右边的 Viewer 窗口就会自动同步所写内容。

![开始内容输出！](https://uploads.cosx.org/2021/03/image-20210725194655246.png)

接下来，靠你自己啦！可以写一些读书笔记，科研想法等。小编这里给出前段时间写的一篇博客的内容作为示范。

![填写内容](https://uploads.cosx.org/2021/03/image-20210725194617200.png)

> **注意**：写好的 MD 文件可以直接将其导入。但是注意的是，图片等需要你手动添加到对应的目录下，或者使用图床进行线上存储，可以参考该篇[教程](https://mp.weixin.qq.com/s/djEicXPS-H-LTFNKDe26ig)。

保存后，new post 就已经完成啦！

![new post 完成](https://uploads.cosx.org/2021/03/image-20210725194742883.png)

### 2.3 使用 GitHub 上传内容

最后一步，将刚才修改过的内容，通过 GitHub 进行上传。操作流程如下，之后等几分钟，Netlify 网站知道你的该 GitHub 仓库内容出现变化后，会自动更新网站。

![上传到 GitHub](https://uploads.cosx.org/2021/03/image-20210725192651824.png)
...
![Hugo主题网站](https://uploads.cosx.org/2021/03/image-20210719163448115.png)
...
![](https://uploads.cosx.org/2021/03/image-20210719144857943.png)

打开对应 GitHub 仓库后，复制名称到创建界面时的（Hugo theme）中。

![](https://uploads.cosx.org/2021/03/image-20210719145024762.png)
