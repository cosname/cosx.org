...
![统计词话配图](https://uploads.cosx.org/wp-content/uploads/2011/03/image.jpg)
...
下面就通过一段R程序来进行一次实际的分析，用到的数据是从网络上整理的《全宋词》电子资料，其中可能有部分字词不正确。完整的程序和数据可以从[这里下载](https://uploads.cosx.org/wp-content/uploads/2011/03/SongPoem.tar.gz)。
