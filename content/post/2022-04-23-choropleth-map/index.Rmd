...
::: {.full-width}
![(\#fig:us-nc-income) 北卡州社区级家庭月收入的空间分布](img/us-nc-income.png){.full}
:::
...
library(cowplot)
# 将数据根据分位点分箱
nc_bi_data <- bi_class(nc_income_race_tract,
  x = pctWhite, y = medInc,
...
最后，咱们回归到本节主旨，家庭月收入和白人占比的**空间相关性**有没有呢？又有多少呢？先来看下家庭月收入的**空间相关性**，这可以用局部莫兰 I 指数刻画，如图\@ref(fig:medinc-moran)所示，红色区域表示
