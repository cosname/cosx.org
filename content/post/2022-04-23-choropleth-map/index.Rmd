...
1. 北卡郡、社区级地图数据的年份和 ACS 调查数据的年份要一致。

1. R 软件内置了数据集 `state.name` 和 `state.abb`，分别对应 美国各个州的名称及其简称，**tidycensus** 包内置的数据集 `fips_codes` 还提供各州、郡的 FIPS 代码。
