...
如图\@ref(fig:bivar-us-states)所示，将家庭月收入和白人占比两个数据的分布联合起来看，融合了上图\@ref(fig:us-nc-income)和图\@ref(fig:us-nc-race2)的数据信息。图中以灰色块表示缺失数据。
...
如图\@ref(fig:medinc-moran)所示，红色区域表示
