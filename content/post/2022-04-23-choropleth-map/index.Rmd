...
结合图\@ref(fig:us-nc-income)和图\@ref(fig:bivar-us-states)，从空间上看，其一，存在明显的分层现象，其二，白人占比指标和家庭收入中位数指标空间相关性非常高，其三，存在低收入在高收入区域穿插的现象，在图\@ref(fig:us-nc-income)中非常明显。
...
![(\#fig:choropleth-map) 7 种绘图方案依赖的 R 包](img/choropleth-map.svg){.full}
