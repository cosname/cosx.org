...
根据调整的 $R^2 = 0.147$，各社区家庭年收入和白人占比相关性比较低，要是相关性到达统计课本里常见的 50\%，甚至更高，那社会问题就大发了！结合图\@ref(fig:lm-income-race)也不难看出**稳定正向**的关系，平均来说，社区的白人占比增加一个百分点，家庭年收入增加**438**美元。
...
类似地，图\@ref(fig:pctwhite-moran)更清晰地描述白人在北卡的分布区域，结合收入分布图\@ref(fig:us-nc-income)和图\@ref(fig:medinc-moran)来看，收入越高的地区白人占比越高，考虑空间因素，$R^2$ 肯定要比 0.147 大多了。
