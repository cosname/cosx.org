...
![central_limit_theorem](https://cos.name/wp-content/uploads/2013/01/central_limit_theorem.jpg)]
...
![clt_proof](https://cos.name/wp-content/uploads/2013/01/clt_proof.jpg)
...
**[中心极限定理充要条件]** 假设独立随机变量序列 `\( X\_i\)` 的中值为0, 要使序列和 `\( \displaystyle S=\sum\_{i=1}^nX_i\)` 的分布密度函数逼近正态分布，以下条件是充分必要的
...
![galton_quetelet](https://cos.name/wp-content/uploads/2013/01/galton_quetelet.jpg)
...
![normal_fitness](https://cos.name/wp-content/uploads/2013/01/normal_fitness.jpg)
...
![galton_quincunx](https://cos.name/wp-content/uploads/2013/01/galton_quincunx.jpg)

**高尔顿钉板**

设想在此装置的中间某个地方 AB 设一个挡板把小球截住，小球将在AB处聚成正态曲线形状，如果挡板上有许多阀门，打开一些阀门，则在底部形成多个大小不一的正态分布，而最终的大正态分布正是这些小正态分布的混合。

![galton_quincunx3](https://cos.name/wp-content/uploads/2013/01/galton_quincunx3.jpg)
...
在这个背景之下，统计学三大分布`\(\chi^2$分布、`\(t\)`分布、`\(F$分布逐步登上历史舞台。这三大分布现在的理科本科生都很熟悉。在历史上，这三个分布和来自英国的现代数理统计学的三大剑客有着密切的关系。
 ...
 ![three-swords](https://cos.name/wp-content/uploads/2013/01/three-swords.jpg)]
...
![youden-normal-curve](https://cos.name/wp-content/uploads/2013/01/youden-normal-curve.jpg)
