...
[<img class="aligncenter size-large wp-image-9628" alt="捕获.1JPG" src="http://cos.name/wp-content/uploads/2014/02/捕获.1JPG-500x216.jpg" width="500" height="216" srcset="http://cos.name/wp-content/uploads/2014/02/捕获.1JPG-500x216.jpg 500w, http://cos.name/wp-content/uploads/2014/02/捕获.1JPG-300x129.jpg 300w, http://cos.name/wp-content/uploads/2014/02/捕获.1JPG.jpg 769w" sizes="(max-width: 500px) 100vw, 500px" />](http://cos.name/wp-content/uploads/2014/02/捕获.1JPG.jpg)接下来计算 RMSE，对比三个模型的评估参数，`calcPredictionError()` 函数可以计算出MAE（绝对值均方误差）、MSE 和 RMSE。
...
[<img class="aligncenter  wp-image-9627" alt="捕获" src="http://cos.name/wp-content/uploads/2014/02/捕获-500x243.jpg" width="500" height="243" srcset="http://cos.name/wp-content/uploads/2014/02/捕获-500x243.jpg 500w, http://cos.name/wp-content/uploads/2014/02/捕获-300x146.jpg 300w, http://cos.name/wp-content/uploads/2014/02/捕获.jpg 679w" sizes="(max-width: 500px) 100vw, 500px" />](http://cos.name/wp-content/uploads/2014/02/捕获.jpg)从上面的两张图可以得出如下结论：
