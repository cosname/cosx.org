...
[![捕获.1JPG](https://cos.name/wp-content/uploads/2014/02/捕获.1JPG-500x216.jpg)](https://cos.name/wp-content/uploads/2014/02/捕获.1JPG.jpg)接下来计算 RMSE，对比三个模型的评估参数，`calcPredictionError()` 函数可以计算出MAE（绝对值均方误差）、MSE 和 RMSE。
...
[![捕获](https://cos.name/wp-content/uploads/2014/02/捕获-500x243.jpg)](https://cos.name/wp-content/uploads/2014/02/捕获.jpg)从上面的两张图可以得出如下结论：
