...
在入门课程教授“非参”数检验的时候，我认为我们可以避开 [欺骗儿童](https://en.wikipedia.org/wiki/Lie-to-children) 的手段，直接告诉学生“非参”检验其实就是和秩相关的参数检验。对学生来说，接受秩的概念比相信你可以神奇地放弃各种假设好的多。实际上，在统计软件 [JASP](https://jasp-stats.org/) 里，“非参”检验的贝叶斯等价模型就是使用 [潜秩](https://arxiv.org/abs/1712.06941)（Latent Rank）来实现的。频率学派的“非参”检验在样本量 $N > 15$ 的时非常准确。
