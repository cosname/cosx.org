...
先通过[官方视频](https://rmarkdown.rstudio.com/lesson-1.html "官方视频")来看看 R Markdown 的介绍。
...
![](https://uploads.cosx.org/2021/04/image-20210424172657080.png)
...
![](https://uploads.cosx.org/2021/04/image-20210424172842613.png)

2.  在弹出的选项框里，可以申明 rmarkdown 的 Title、 Author 以及默认的输出文件格式，一般可以选择 HTML、PDF、Word 格式，具体见下图。

![](https://uploads.cosx.org/2021/04/image-20210424172859520.png)

3.  在新建的 markdown 文件里，主要包含三块内容：1. YAML、2. markdown 文本、3.代码块。

![](https://uploads.cosx.org/2021/04/image-20210424172919598.png)
...
![](https://uploads.cosx.org/2021/04/image-20210424172937025.png)
...
![](https://uploads.cosx.org/2021/04/image-20210424173011826.png)

### 2.4. RStudio界面介绍

若界面打开了rmd格式的文件时， RStudio 的界面发生了一些变化（多了一些按钮），如下图所示。

![](https://uploads.cosx.org/2021/04/image-20210414130134283.png)
...
6. 错误信息选项
    ...
    ![](https://uploads.cosx.org/2021/04/WeChatd2107f6cf1d1088d22c97e4b3e09f344.png)
...
如果一个图不是由一个 R 代码块生成的，你可以用三种方式包含它:
  ...
  使用 Markdown 语法 `![caption](https://uploads.cosx.org/2021/04/image)`， 你可以使用 `width` 和 `height` 属性来设置图像的大小，例如:
  ...
  ![](https://uploads.cosx.org/2021/04/image-20210403211033682.png)
...
![](https://uploads.cosx.org/2021/04/image-20210403211101185.png)
...
![](https://uploads.cosx.org/2021/04/image-20210403210427161.png)

- Typora格式

![](https://uploads.cosx.org/2021/04/image-20210403211149020.png)
...
![](https://uploads.cosx.org/2021/04/image-20210403211210045.png)
...
![](https://uploads.cosx.org/2021/04/image-20210403211229254.png)
...
![](https://uploads.cosx.org/2021/04/image-20210403211332249.png)
...
![](https://uploads.cosx.org/2021/04/image-20210403211413207.png)
...
![](https://uploads.cosx.org/2021/04/image-20210424173324184.png)
...
![](https://uploads.cosx.org/2021/04/image-20210403211439668.png)
...
![](https://uploads.cosx.org/2021/04/image-20210403211506891.png)
...
![](https://uploads.cosx.org/2021/04/image-20210403211527153.png)
...
![](https://uploads.cosx.org/2021/04/image-20210403211552162.png)



## 第四章： R Markdown 的主题格式
...
![](https://uploads.cosx.org/2021/04/image-20210315195440875.png)

编译后得到的结果，这是他模板原始的样子，如果想调整页面行间距，字体颜色等，请见下面一章。

![](https://uploads.cosx.org/2021/04/image-20210315195456780.png)
...
![](https://uploads.cosx.org/2021/04/image-20210315195508990.png)

**方法二：**

在你安装完该包之后你可以使用通过按钮新建该模版（其实他有很多类似的模板，我这里只展现了一种）：

![](https://uploads.cosx.org/2021/04/image-20210315195516091.png)
...
![](https://uploads.cosx.org/2021/04/image-20210315195521796.png)
...
![](https://uploads.cosx.org/2021/04/image-20210315195528253.png)
...
![](https://uploads.cosx.org/2021/04/image-20210315195535713.png)
...
关于RMarkdown使用时，小编日常会使用的一些有用技巧，当然我也是通过学习谢大大的[R Markdown-cookbook](https://bookdown.org/yihui/rmarkdown-cookbook/ "R Markdown-cookbook")以及日常使用需求上网搜的解决方案，在此分享给大家。如果大家还有其他什么需求，可以在留言板留言。或者有其他实用技巧也欢迎分享！
...
![](https://uploads.cosx.org/2021/04/image-20210318124743606.png)
...
![](https://uploads.cosx.org/2021/04/image-20210318132951265.png)

当然全文字体大小等操作也是这样操作的，在 geometry 操作即可：

![](https://uploads.cosx.org/2021/04/image-20210318123645722.png)
...
![](https://uploads.cosx.org/2021/04/image-20210318125239921.png)

### 5.4.分页

如果想要分页，可以使用 `\newpage`。 例如：如果想把目录和正文内容分开，可以在在正文前面加入这个代码

![](https://uploads.cosx.org/2021/04/image-20210319193017798.png)

这时输出的结果，目录一个界面，正文另起一页。

![](https://uploads.cosx.org/2021/04/image-20210319193045376.png)
...
![](https://uploads.cosx.org/2021/04/image-20210318125512209.png)
...
![](https://uploads.cosx.org/2021/04/image-20210318125542194.png)
...
![](https://uploads.cosx.org/2021/04/image-20210318130218480.png)
...
```
![A nice image.](https://uploads.cosx.org/2021/04/bar.png){width=50%}
```

### 5.7. 图片对齐

这个我也说过啦！可见：[R 沟通｜R Markdown教程（3）](http://mp.weixin.qq.com/s?__biz=MzI1NjUwMjQxMQ==&mid=2247491844&idx=1&sn=36decacb06ca6ce1fc689141174bb98f&chksm=ea271ee0dd5097f615b87c27151200635a9e5ff3c3072864bcf8fe6e8fbc41c0cffc6c95148f&scene=21#wechat_redirect)，[ R沟通｜R Markdown教程（2）](http://mp.weixin.qq.com/s?__biz=MzI1NjUwMjQxMQ==&mid=2247491546&idx=1&sn=00f8dea8903dbf4ec6e683ab5061a7a5&chksm=ea24e03edd536928ff6c5a3600c8fbbd87cafbf9286ad47bfe4c084032cada9bf6ee7dfddcd9&scene=21#wechat_redirect)。如果使用R代码导入图片的话，使用 `knitr::include_graphics()` 并结合 R chunk 中 `fig.align = 'center'` 参数进行居中。如果结果不想显示代码块，可在chunck中加入： `echo=FALSE`。
...
![](https://uploads.cosx.org/2021/04/image-20210318131400399.png)
...
![](https://uploads.cosx.org/2021/04/image-20210319195033178.png)
...
![](https://uploads.cosx.org/2021/04/9601618034106_.pic_hd.jpg)
