...
[<img class=" wp-image-10888 size-full aligncenter" src="http://cos.name/wp-content/uploads/2015/04/spark-regression.png" alt="spark-regression" width="810" height="782" srcset="http://cos.name/wp-content/uploads/2015/04/spark-regression.png 810w, http://cos.name/wp-content/uploads/2015/04/spark-regression-300x290.png 300w, http://cos.name/wp-content/uploads/2015/04/spark-regression-500x483.png 500w" sizes="(max-width: 810px) 100vw, 810px" />](http://cos.name/wp-content/uploads/2015/04/spark-regression.png)（复制代码可以去[这里](http://yixuan.cos.name/cn/2015/04/spark-beginner-1/)）
