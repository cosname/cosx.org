...
请进行如下操作：
  ...
  * 点击菜单 **<span style="color: #ff0000;"><code>File -&gt; New File -&gt; R Markdown -&gt; From Template -&gt; Ninja Presentation (Simplified Chinese)</code> </span>**创建一个新文档。![](https://cos.name/wp-content/uploads/2017/02/fig1-500x313.png)
  * 点击 Knit 进行编译

![](https://cos.name/wp-content/uploads/2017/02/fig2-500x313.png)
...
![](https://cos.name/wp-content/uploads/2017/02/fig3-500x313.png)
