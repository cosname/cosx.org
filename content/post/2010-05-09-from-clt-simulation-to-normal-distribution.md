...
description: "正态分布在统计中的地位如此之重要，以至于人们几乎认为正态是一种自然而然的分布，本文想说明的是，正态有它的自然性，但我们不能逮着两边低中间高的东西都叫正态；做模型或分析数据之前，先清空脑子里的这种“正态教义”，用事实说话。"
...
![两次掷骰子得到的结果之和的分布](https://uploads.cosx.org/wp-content/uploads/2010/05/sim-dice-hist.png "两次掷骰子得到的结果之和的分布")
两次掷骰子得到的结果之和的分布 
...
![6个数字中2个样本之和的分布](https://uploads.cosx.org/wp-content/uploads/2010/05/sim-6num-hist.png "6个数字中2个样本之和的分布")
6个数字中2个样本之和的分布
...
![中心极限定理模拟：从指数分布到正态分布](https://uploads.cosx.org/wp-content/uploads/2010/05/clt-rexp-demo.gif)
中心极限定理模拟：从指数分布到正态分布
