...
![Iris 数据的轮廓图(Parallel Coordinate Plots)](https://cos.name/wp-content/uploads/2009/03/parallel2-300x284.png)<figcaption class="wp-caption-text">图1 Iris 数据的轮廓图(Parallel Coordinate Plots)</figcaption></figure> 
...
![Iris 数据的调和曲线图](https://cos.name/wp-content/uploads/2009/03/unison-300x299.png)<figcaption class="wp-caption-text">图2 Iris 数据的调和曲线图</figcaption></figure> 
