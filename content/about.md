...
本站的组织形式为：[主站](http://cos.name "COS主站") + [中文论坛](http://cos.name/cn "COS论坛")。
...
除了线上的交流之外，统计之都社区还定期开展一系列的线下活动，其中最重要的是自 2008 年以来一直延续至今的[中国 R 语言会议](http://cos.name/chinar/)，每年分别于 5 月和 11 月在北京和上海召开。

自 2012 年以来，统计之都还开展了一系列的[数据分析沙龙](http://cos.name/tag/salon/)，其主题涵盖了可视化、生物信息、金融、空间统计、海量数据处理等众多前沿的统计学问题。
...
详细参加方式请参见页面<a title="用户如何参加“统计之都”的各项工作" href="http://cos.name/2008/11/how-to-work-with-cos/" target="_blank">用户如何参加“统计之都”的各项工作</a>。
